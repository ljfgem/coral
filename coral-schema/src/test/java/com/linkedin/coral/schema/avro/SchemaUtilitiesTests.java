...
//    Schema.Field field1 =
//        new Schema.Field("one", dummySchema, "", dummySchema.getObjectProp("key"), Schema.Field.Order.IGNORE);
//    field1.addProp("field_key1", "field_value1");
//    Schema.Field field2 =
//        new Schema.Field("two", dummySchema, "", dummySchema.getObjectProp("key"), Schema.Field.Order.IGNORE);
