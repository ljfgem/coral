  ...
  Schema convertFieldsTypeInfoToAvroSchema(String recordNamespace, String recordName, List<String> fieldNames,
    ...
    for (int i = 0; i < fieldNames.size(); ++i) {
      ...
      final Schema.Field f = AvroCompatibilityHelper.createSchemaField(fieldName, schema, null,
          mkFieldsOptional ? JsonProperties.NULL_VALUE : null);
      fields.add(f);
    }
  ...
  private Schema parseSchemaFromPrimitive(PrimitiveTypeInfo primitiveTypeInfo) {
    ...
    switch (primitiveTypeInfo.getPrimitiveCategory()) {
      ...
      case DECIMAL:
        ...
        schema.addProp(AvroSerDe.AVRO_PROP_PRECISION, dti.getPrecision());
        schema.addProp(AvroSerDe.AVRO_PROP_SCALE, dti.getScale());
        break;
