...
public class TranslationController implements ApplicationListener<ContextRefreshedEvent> {
  ...
  @GetMapping("/translation/from/{fromLanguage}/to/{toLanguage}/query/{query}")
  public ResponseEntity translate(@PathVariable String fromLanguage, @PathVariable String toLanguage,
