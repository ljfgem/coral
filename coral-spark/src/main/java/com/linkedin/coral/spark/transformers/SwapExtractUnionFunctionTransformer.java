 ...
 */
public class SwapExtractUnionFunctionTransformer extends SqlCallTransformer {
  ...
  public SwapExtractUnionFunctionTransformer(Set<SparkUDFInfo> sparkUDFInfos) {
  ...
  protected SqlCall transform(SqlCall sqlCall) {
    ...
    final SqlOperator coalesceStructFunction = CalciteUtil.createSqlOperatorOfFunction(COALESCE_STRUCT,
        CoalesceStructUtility.COALESCE_STRUCT_FUNCTION_RETURN_STRATEGY);
