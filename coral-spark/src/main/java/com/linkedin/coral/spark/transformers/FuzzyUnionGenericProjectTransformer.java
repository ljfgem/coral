...
/**
 * Since the input SqlCall is already `generic_project(b, hive_type_string)` (check {@link com.linkedin.coral.common.FuzzyUnionSqlRewriter#createGenericProject(String, RelDataType)}),
 * we don't need to transform it. Just need to register the `GenericProject` UDF.
 */
