...
#### /translation/from/{fromLanguage}/to/{toLanguage}/query/{query}
...
curl -X POST "http://localhost:8080/creation?statement=CREATE%20DATABASE%20IF%20NOT%20EXISTS%20db1"
Creation successful
```
...
curl -X POST "http://localhost:8080/creation?statement=CREATE%20TABLE%20IF%20NOT%20EXISTS%20db1.airport%28name%20string%2C%20country%20string%2C%20area_code%20int%2C%20code%20string%2C%20datepartition%20string%29"
```
...
curl "http://localhost:8080/translation/from/hive/to/trino/query/SELECT%20%2A%20FROM%20db1.airport"
```
